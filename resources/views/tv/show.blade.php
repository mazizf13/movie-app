                ...
                @foreach ($tvshow['images'] as $image)
                    <div class="mt-8">
                        <a
                            ...
                            href="#"
                        >
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path'] }}" alt="{{ $tvshow['name'] }}" class="hover:opacity-75 transition ease-in-out duration-100">
                        </a>
                    </div>
                @endforeach
            </div>
