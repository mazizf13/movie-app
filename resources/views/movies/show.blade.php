                ...
                @foreach ($movie['cast'] as $cast)
                    <div class="mt-8">
                        <a href="{{ route('actors.show', $cast['id']) }}">
                            <img src="{{ $cast['profile_path'] ? 'https://image.tmdb.org/t/p/w300/'.$cast['profile_path'] : 'https://via.placeholder.com/300x450' }}" alt="{{ $cast['name'] }}" class="hover:opacity-75 transition ease-in-out duration-100">
                        </a>
                        <div class="mt-2">
                ...
                @foreach ($movie['images'] as $image)
                    <div class="mt-8">
                        <a
                            ...
                            href="#"
                        >
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path'] }}" alt="{{ $movie['title'] }}"" class="hover:opacity-75 transition ease-in-out duration-100">
                        </a>
                    </div>
                @endforeach
            </div>
