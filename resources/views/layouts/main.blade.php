...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-8 flex flex-col md:flex-row items-center justify-between py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="/img/aziz.jpg" alt="aziz" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
    ...
    <footer class="border border-t border-gray-800">
        <div class="container mx-auto px-4 py-6 text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2024 <a href="https://www.linkedin.com/in/mazizf13/" class="hover:underline hover:text-gray-300" target="_blank">Mas Aziz</a> All Right Reserved.
        </div>
    </footer>
